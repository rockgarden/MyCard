...
public class BaseItem {
    ...
    private static TestItem createDummyItem(int position) {
        return new TestItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    /**
     * A dummy item_record representing a piece of content.
     */
