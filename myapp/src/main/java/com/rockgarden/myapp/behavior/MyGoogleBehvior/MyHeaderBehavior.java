 ...
 * Behavior will automatically sets up a {ViewOffsetBehavior} on a {@link View}.
 *
 * Created by rockgarden on 16/6/7.
 */
class MyHeaderBehavior<V extends View> extends MyViewOffsetBehavior<V> {
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout parent, V header, int newOffset,
        ...
        if (minOffset != 0 && curOffset >= minOffset && curOffset <= maxOffset) {
            ...
            newOffset = MyMathUtils.constrain(newOffset, minOffset, maxOffset);
