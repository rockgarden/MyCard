 ...
 * See {MyHeaderBehavior}.
 */
abstract class MyHeaderScrollingViewBehavior extends MyViewOffsetBehavior<View> {
    ...
    final int getOverlapPixelsForOffset(final View header) {
        return mOverlayTop == 0
                ? 0
                : MyMathUtils.constrain(Math.round(getOverlapRatioForOffset(header) * mOverlayTop),
                0, mOverlayTop);
