...
/**
 * Behavior will automatically sets up a {@link MyViewOffsetHelper} on a {@link View}.
 *
 * Created by rockgarden on 16/6/7.
 */
class MyViewOffsetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public MyViewOffsetBehavior() {}

    public MyViewOffsetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
