 ...
 */
public class MaterialProgressDrawable_bug extends Drawable implements Animatable {
    ...
    boolean mFinishing;
    private boolean mShowArrowOnFirstStart = false; //先显示箭头?

    public MaterialProgressDrawable_bug(Context context, View parent) {
        mParent = parent;
    ...
    public void start() {
        ...
        mRing.setShowArrow(mShowArrowOnFirstStart); //只显示箭头
