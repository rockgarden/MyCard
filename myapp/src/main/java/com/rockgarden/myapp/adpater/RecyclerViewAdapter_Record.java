 ...
 */
public class RecyclerViewAdapter_Record extends RecyclerView.Adapter<RecyclerViewAdapter_Record.ViewHolder> {
...
//    }
    ...
    @Override
    public RecyclerViewAdapter_Record.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Record.ViewHolder viewHolder, int position) {
